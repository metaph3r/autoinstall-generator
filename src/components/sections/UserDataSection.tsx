...
export function UserDataSection(): JSX.Element {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
      ...
      <TextField
        label="GECOS"
        fullWidth
        helperText="Optional GECOS field"
      ...
      <TextField
        ...
        type="password"
        fullWidth
        helperText="Optional hashed password"
      ...
      <TextField
        label="Groups"
        fullWidth
        helperText="Optional comma-separated groups"
      ...
      <TextField
        label="Shell"
        fullWidth
        helperText="Optional login shell (e.g. /bin/bash)"
